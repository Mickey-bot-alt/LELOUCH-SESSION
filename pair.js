...
async function uploadCredsToMega(credsPath) {
    try {
        const storage = await new Storage({
            email: 'wiloyom304@motivue.com', // Your Mega A/c Email Here
            password: 'QWERTY123LELOUCH+' // Your Mega A/c Password Here
        }).ready;
            ...
            Malvin.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    const sid = megaUrl.includes("https://mega.nz/file/")
                        ? 'LELOUCH-MD~' + megaUrl.split("https://mega.nz/file/")[1]
                        : 'Error: Invalid URL';
...
💡 *Whats Next?* 
1️⃣ Explore all the cool features of LELOUCH-MD.
